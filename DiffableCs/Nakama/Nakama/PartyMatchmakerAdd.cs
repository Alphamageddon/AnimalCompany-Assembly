...
internal class PartyMatchmakerAdd
{
	...
	[CompilerGenerated]
	private int <MaxCount>k__BackingField; //Field offset: 0x18
	[CompilerGenerated]
	private int <MinCount>k__BackingField; //Field offset: 0x1C
	[CompilerGenerated]
	...
	[CompilerGenerated]
	private Dictionary<String, Double> <NumericProperties>k__BackingField; //Field offset: 0x30
	[CompilerGenerated]
	private Nullable<Int32> <CountMultiple>k__BackingField; //Field offset: 0x38
