...
public class Keyboard : InputDevice, ITextInputReceiver
{
	...
	[CompilerGenerated]
	private AnyKeyControl <anyKey>k__BackingField; //Field offset: 0x170
	[CompilerGenerated]
	private ButtonControl <shiftKey>k__BackingField; //Field offset: 0x178
	[CompilerGenerated]
	private ButtonControl <ctrlKey>k__BackingField; //Field offset: 0x180
	[CompilerGenerated]
	private ButtonControl <altKey>k__BackingField; //Field offset: 0x188
	[CompilerGenerated]
	private ButtonControl <imeSelected>k__BackingField; //Field offset: 0x190
	private InlinedArray<Action`1<Char>> m_TextInputListeners; //Field offset: 0x198
	private string m_KeyboardLayoutName; //Field offset: 0x1B0
	private KeyControl[] m_Keys; //Field offset: 0x1B8
	private InlinedArray<Action`1<IMECompositionString>> m_ImeCompositionListeners; //Field offset: 0x1C0
