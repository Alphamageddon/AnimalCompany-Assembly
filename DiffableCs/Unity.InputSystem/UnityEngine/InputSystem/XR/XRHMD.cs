...
{
	[CompilerGenerated]
	private Vector3Control <leftEyePosition>k__BackingField; //Field offset: 0x190
	[CompilerGenerated]
	private QuaternionControl <leftEyeRotation>k__BackingField; //Field offset: 0x198
	[CompilerGenerated]
	private Vector3Control <rightEyePosition>k__BackingField; //Field offset: 0x1A0
	[CompilerGenerated]
	private QuaternionControl <rightEyeRotation>k__BackingField; //Field offset: 0x1A8
	[CompilerGenerated]
	private Vector3Control <centerEyePosition>k__BackingField; //Field offset: 0x1B0
	[CompilerGenerated]
	private QuaternionControl <centerEyeRotation>k__BackingField; //Field offset: 0x1B8
