...
internal class InputActionState : IInputStateChangeMonitor, ICloneable, IDisposable
{
	...
	private sealed class <>c
	{
		...
		public static TypedRestore<GlobalState> <>9__135_0; //Field offset: 0x8
		public static Action <>9__135_1; //Field offset: 0x10

		private static <>c() { }

		public <>c() { }

		internal void <SaveAndResetState>b__135_0(ref GlobalState state) { }
	...
	internal void ChangePhaseOfInteraction(InputActionPhase newPhase, ref TriggerState trigger, InputActionPhase phaseAfterPerformed = 1, bool processNextInteractionOnCancel = true) { }
