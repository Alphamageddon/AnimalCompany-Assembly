...
public class AxisControl : InputControl<Single>
{
	...
	public Clamp clamp; //Field offset: 0x104
	public float clampMin; //Field offset: 0x108
	public float clampMax; //Field offset: 0x10C
	public float clampConstant; //Field offset: 0x110
	public bool invert; //Field offset: 0x114
	public bool normalize; //Field offset: 0x115
	public float normalizeMin; //Field offset: 0x118
	public float normalizeMax; //Field offset: 0x11C
	public float normalizeZero; //Field offset: 0x120
	public bool scale; //Field offset: 0x124
	public float scaleFactor; //Field offset: 0x128
