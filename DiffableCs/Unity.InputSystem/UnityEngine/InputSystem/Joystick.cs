...
public class Joystick : InputDevice
{
	...
	[CompilerGenerated]
	private ButtonControl <trigger>k__BackingField; //Field offset: 0x170
	[CompilerGenerated]
	private StickControl <stick>k__BackingField; //Field offset: 0x178
	[CompilerGenerated]
	private AxisControl <twist>k__BackingField; //Field offset: 0x180
	[CompilerGenerated]
	private Vector2Control <hatswitch>k__BackingField; //Field offset: 0x188
