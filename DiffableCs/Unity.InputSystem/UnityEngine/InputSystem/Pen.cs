...
public class Pen : Pointer
{
	...
	[CompilerGenerated]
	private ButtonControl <tip>k__BackingField; //Field offset: 0x1A0
	[CompilerGenerated]
	private ButtonControl <eraser>k__BackingField; //Field offset: 0x1A8
	[CompilerGenerated]
	private ButtonControl <firstBarrelButton>k__BackingField; //Field offset: 0x1B0
	[CompilerGenerated]
	private ButtonControl <secondBarrelButton>k__BackingField; //Field offset: 0x1B8
	[CompilerGenerated]
	private ButtonControl <thirdBarrelButton>k__BackingField; //Field offset: 0x1C0
	[CompilerGenerated]
	private ButtonControl <fourthBarrelButton>k__BackingField; //Field offset: 0x1C8
	[CompilerGenerated]
	private ButtonControl <inRange>k__BackingField; //Field offset: 0x1D0
	[CompilerGenerated]
	private Vector2Control <tilt>k__BackingField; //Field offset: 0x1D8
	[CompilerGenerated]
	private AxisControl <twist>k__BackingField; //Field offset: 0x1E0
