...
public class TouchSimulation : MonoBehaviour, IInputStateChangeMonitor
{
	...
	private int m_LastTouchId; //Field offset: 0x50
	private int m_PrimaryTouchIndex; //Field offset: 0x54
	private Action<InputDevice, InputDeviceChange> m_OnDeviceChange; //Field offset: 0x58
	private Action<InputEventPtr, InputDevice> m_OnEvent; //Field offset: 0x60
