...
public class HololensHand : XRController
{
	...
	[CompilerGenerated]
	private ButtonControl <airTap>k__BackingField; //Field offset: 0x198
	[CompilerGenerated]
	private AxisControl <sourceLossRisk>k__BackingField; //Field offset: 0x1A0
	[CompilerGenerated]
	private Vector3Control <sourceLossMitigationDirection>k__BackingField; //Field offset: 0x1A8
