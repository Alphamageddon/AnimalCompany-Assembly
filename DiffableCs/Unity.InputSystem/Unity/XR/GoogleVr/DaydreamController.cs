...
public class DaydreamController : XRController
{
	...
	[CompilerGenerated]
	private ButtonControl <volumeUp>k__BackingField; //Field offset: 0x198
	[CompilerGenerated]
	private ButtonControl <recentered>k__BackingField; //Field offset: 0x1A0
	[CompilerGenerated]
	private ButtonControl <volumeDown>k__BackingField; //Field offset: 0x1A8
	[CompilerGenerated]
	private ButtonControl <recentering>k__BackingField; //Field offset: 0x1B0
	[CompilerGenerated]
	private ButtonControl <app>k__BackingField; //Field offset: 0x1B8
	[CompilerGenerated]
	private ButtonControl <home>k__BackingField; //Field offset: 0x1C0
	[CompilerGenerated]
	private ButtonControl <touchpadClicked>k__BackingField; //Field offset: 0x1C8
	[CompilerGenerated]
	private ButtonControl <touchpadTouched>k__BackingField; //Field offset: 0x1D0
	[CompilerGenerated]
	private Vector3Control <deviceVelocity>k__BackingField; //Field offset: 0x1D8
	[CompilerGenerated]
	private Vector3Control <deviceAcceleration>k__BackingField; //Field offset: 0x1E0
