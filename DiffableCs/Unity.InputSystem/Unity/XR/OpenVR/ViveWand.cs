...
{
	[CompilerGenerated]
	private AxisControl <grip>k__BackingField; //Field offset: 0x190
	[CompilerGenerated]
	private ButtonControl <gripPressed>k__BackingField; //Field offset: 0x198
	[CompilerGenerated]
	private ButtonControl <primary>k__BackingField; //Field offset: 0x1A0
	[CompilerGenerated]
	private ButtonControl <trackpadPressed>k__BackingField; //Field offset: 0x1A8
	[CompilerGenerated]
	private ButtonControl <trackpadTouched>k__BackingField; //Field offset: 0x1B0
	[CompilerGenerated]
	private Vector2Control <trackpad>k__BackingField; //Field offset: 0x1B8
	[CompilerGenerated]
	private AxisControl <trigger>k__BackingField; //Field offset: 0x1C0
	[CompilerGenerated]
	private ButtonControl <triggerPressed>k__BackingField; //Field offset: 0x1C8
	[CompilerGenerated]
	private Vector3Control <deviceVelocity>k__BackingField; //Field offset: 0x1D0
	[CompilerGenerated]
	private Vector3Control <deviceAngularVelocity>k__BackingField; //Field offset: 0x1D8
