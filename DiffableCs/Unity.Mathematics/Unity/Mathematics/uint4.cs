...
public struct uint4 : IEquatable<uint4>, IFormattable
{
	public sealed class DebuggerProxy
	{
		...
		public uint w; //Field offset: 0x1C
	...
	public static uint4 op_Addition(uint lhs, uint4 rhs) { }

	public static uint4 op_Addition(uint4 lhs, uint rhs) { }

	public static uint4 op_BitwiseAnd(uint lhs, uint4 rhs) { }

	public static uint4 op_BitwiseAnd(uint4 lhs, uint rhs) { }

	public static uint4 op_BitwiseAnd(uint4 lhs, uint4 rhs) { }

	public static uint4 op_BitwiseOr(uint4 lhs, uint rhs) { }

	public static uint4 op_BitwiseOr(uint lhs, uint4 rhs) { }

	public static uint4 op_BitwiseOr(uint4 lhs, uint4 rhs) { }

	public static uint4 op_Decrement(uint4 val) { }

	public static uint4 op_Division(uint4 lhs, uint rhs) { }

	public static uint4 op_Division(uint lhs, uint4 rhs) { }

	public static uint4 op_Division(uint4 lhs, uint4 rhs) { }

	public static bool4 op_Equality(uint4 lhs, uint rhs) { }

	public static bool4 op_Equality(uint4 lhs, uint4 rhs) { }

	public static bool4 op_Equality(uint lhs, uint4 rhs) { }

	public static uint4 op_ExclusiveOr(uint lhs, uint4 rhs) { }

	public static uint4 op_ExclusiveOr(uint4 lhs, uint rhs) { }
	...
	public static bool4 op_GreaterThan(uint lhs, uint4 rhs) { }

	public static bool4 op_GreaterThanOrEqual(uint4 lhs, uint4 rhs) { }

	public static bool4 op_GreaterThanOrEqual(uint lhs, uint4 rhs) { }

	public static bool4 op_GreaterThanOrEqual(uint4 lhs, uint rhs) { }
	...
	public static bool4 op_Inequality(uint lhs, uint4 rhs) { }

	public static bool4 op_Inequality(uint4 lhs, uint rhs) { }

	public static uint4 op_LeftShift(uint4 x, int n) { }

	public static bool4 op_LessThan(uint4 lhs, uint rhs) { }

	public static bool4 op_LessThan(uint4 lhs, uint4 rhs) { }

	public static bool4 op_LessThan(uint lhs, uint4 rhs) { }

	public static bool4 op_LessThanOrEqual(uint lhs, uint4 rhs) { }

	public static bool4 op_LessThanOrEqual(uint4 lhs, uint4 rhs) { }

	public static bool4 op_LessThanOrEqual(uint4 lhs, uint rhs) { }

	public static uint4 op_Modulus(uint4 lhs, uint rhs) { }

	public static uint4 op_Modulus(uint4 lhs, uint4 rhs) { }

	public static uint4 op_Modulus(uint lhs, uint4 rhs) { }

	public static uint4 op_Multiply(uint4 lhs, uint4 rhs) { }

	public static uint4 op_Multiply(uint4 lhs, uint rhs) { }

	public static uint4 op_Multiply(uint lhs, uint4 rhs) { }
	...
	public static uint4 op_Subtraction(uint4 lhs, uint rhs) { }

	public static uint4 op_Subtraction(uint lhs, uint4 rhs) { }
