...
public static class math
{
	...
	public static float4 projectsafe(float4 a, float4 b, float4 defaultValue = null) { }

	public static double2 projectsafe(double2 a, double2 b, double2 defaultValue = null) { }

	public static double3 projectsafe(double3 a, double3 b, double3 defaultValue = null) { }

	public static double4 projectsafe(double4 a, double4 b, double4 defaultValue = null) { }

	public static float3 projectsafe(float3 a, float3 b, float3 defaultValue = null) { }

	public static float2 projectsafe(float2 a, float2 b, float2 defaultValue = null) { }
