...
public struct double4 : IEquatable<double4>, IFormattable
{
	...
	{
		public double x; //Field offset: 0x10
		public double y; //Field offset: 0x18
		public double z; //Field offset: 0x20
		public double w; //Field offset: 0x28

		public DebuggerProxy(double4 v) { }

	}

	public static readonly double4 zero; //Field offset: 0x0
	public double x; //Field offset: 0x0
	public double y; //Field offset: 0x8
	public double z; //Field offset: 0x10
	public double w; //Field offset: 0x18
	...
	public override bool Equals(double4 rhs) { }
	...
	public static double4 op_Implicit(uint v) { }
