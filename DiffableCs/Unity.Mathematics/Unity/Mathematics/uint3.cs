...
public struct uint3 : IEquatable<uint3>, IFormattable
{
	...
	{
		public uint x; //Field offset: 0x10
		public uint y; //Field offset: 0x14
		public uint z; //Field offset: 0x18

		public DebuggerProxy(uint3 v) { }

	}

	public static readonly uint3 zero; //Field offset: 0x0
	...
	public static uint3 op_Addition(uint lhs, uint3 rhs) { }

	public static uint3 op_Addition(uint3 lhs, uint rhs) { }

	public static uint3 op_Addition(uint3 lhs, uint3 rhs) { }

	public static uint3 op_BitwiseAnd(uint lhs, uint3 rhs) { }

	public static uint3 op_BitwiseAnd(uint3 lhs, uint3 rhs) { }

	public static uint3 op_BitwiseAnd(uint3 lhs, uint rhs) { }

	public static uint3 op_BitwiseOr(uint3 lhs, uint rhs) { }

	public static uint3 op_BitwiseOr(uint lhs, uint3 rhs) { }

	public static uint3 op_BitwiseOr(uint3 lhs, uint3 rhs) { }

	public static uint3 op_Decrement(uint3 val) { }

	public static uint3 op_Division(uint lhs, uint3 rhs) { }

	public static uint3 op_Division(uint3 lhs, uint rhs) { }

	public static uint3 op_Division(uint3 lhs, uint3 rhs) { }

	public static bool3 op_Equality(uint lhs, uint3 rhs) { }

	public static bool3 op_Equality(uint3 lhs, uint rhs) { }

	public static bool3 op_Equality(uint3 lhs, uint3 rhs) { }

	public static uint3 op_ExclusiveOr(uint3 lhs, uint rhs) { }

	public static uint3 op_ExclusiveOr(uint3 lhs, uint3 rhs) { }

	public static uint3 op_ExclusiveOr(uint lhs, uint3 rhs) { }
	...
	public static bool3 op_GreaterThan(uint3 lhs, uint rhs) { }

	public static bool3 op_GreaterThan(uint3 lhs, uint3 rhs) { }

	public static bool3 op_GreaterThan(uint lhs, uint3 rhs) { }

	public static bool3 op_GreaterThanOrEqual(uint lhs, uint3 rhs) { }

	public static bool3 op_GreaterThanOrEqual(uint3 lhs, uint rhs) { }

	public static bool3 op_GreaterThanOrEqual(uint3 lhs, uint3 rhs) { }

	public static uint3 op_Implicit(uint v) { }

	public static uint3 op_Increment(uint3 val) { }

	public static bool3 op_Inequality(uint3 lhs, uint3 rhs) { }

	public static bool3 op_Inequality(uint lhs, uint3 rhs) { }

	public static bool3 op_Inequality(uint3 lhs, uint rhs) { }

	public static uint3 op_LeftShift(uint3 x, int n) { }

	public static bool3 op_LessThan(uint3 lhs, uint3 rhs) { }

	public static bool3 op_LessThan(uint lhs, uint3 rhs) { }

	public static bool3 op_LessThan(uint3 lhs, uint rhs) { }

	public static bool3 op_LessThanOrEqual(uint lhs, uint3 rhs) { }

	public static bool3 op_LessThanOrEqual(uint3 lhs, uint rhs) { }

	public static bool3 op_LessThanOrEqual(uint3 lhs, uint3 rhs) { }

	public static uint3 op_Modulus(uint3 lhs, uint rhs) { }

	public static uint3 op_Modulus(uint3 lhs, uint3 rhs) { }

	public static uint3 op_Modulus(uint lhs, uint3 rhs) { }

	public static uint3 op_Multiply(uint lhs, uint3 rhs) { }

	public static uint3 op_Multiply(uint3 lhs, uint3 rhs) { }

	public static uint3 op_Multiply(uint3 lhs, uint rhs) { }

	public static uint3 op_OnesComplement(uint3 val) { }

	public static uint3 op_RightShift(uint3 x, int n) { }

	public static uint3 op_Subtraction(uint3 lhs, uint rhs) { }

	public static uint3 op_Subtraction(uint3 lhs, uint3 rhs) { }

	public static uint3 op_Subtraction(uint lhs, uint3 rhs) { }
