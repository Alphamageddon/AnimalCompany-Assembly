...
{
	private bool m_closed; //Field offset: 0x19
	private long m_contentLength; //Field offset: 0x20
	private FileAccess m_fileAccess; //Field offset: 0x28
	private WebHeaderCollection m_headers; //Field offset: 0x30
	private Stream m_stream; //Field offset: 0x38
	private Uri m_uri; //Field offset: 0x40
