...
public class Image : MaskableGraphic, ISerializationCallbackReceiver, ILayoutElement, ICanvasRaycastFilter
{
	...
	[SerializeField]
	private Sprite m_Sprite; //Field offset: 0xD8
	private Sprite m_OverrideSprite; //Field offset: 0xE0
	[SerializeField]
	private Type m_Type; //Field offset: 0xE8
	[SerializeField]
	private bool m_PreserveAspect; //Field offset: 0xEC
	[SerializeField]
	private bool m_FillCenter; //Field offset: 0xED
	[SerializeField]
	private FillMethod m_FillMethod; //Field offset: 0xF0
	[Range(0, 1)]
	[SerializeField]
	private float m_FillAmount; //Field offset: 0xF4
	[SerializeField]
	private bool m_FillClockwise; //Field offset: 0xF8
	[SerializeField]
	private int m_FillOrigin; //Field offset: 0xFC
	private float m_AlphaHitTestMinimumThreshold; //Field offset: 0x100
	private bool m_Tracked; //Field offset: 0x104
	[SerializeField]
	private bool m_UseSpriteMesh; //Field offset: 0x105
	[SerializeField]
	private float m_PixelsPerUnitMultiplier; //Field offset: 0x108
	private float m_CachedReferencePixelsPerUnit; //Field offset: 0x10C
