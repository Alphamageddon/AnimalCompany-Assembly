...
public class ContextualMenuPopulateEvent : MouseEventBase<ContextualMenuPopulateEvent>
{
	...
	private DropdownMenu <menu>k__BackingField; //Field offset: 0xB8
	[CompilerGenerated]
	[DebuggerBrowsable(DebuggerBrowsableState::Never (0))]
	private EventBase <triggerEvent>k__BackingField; //Field offset: 0xC0
	private ContextualMenuManager m_ContextualMenuManager; //Field offset: 0xC8
