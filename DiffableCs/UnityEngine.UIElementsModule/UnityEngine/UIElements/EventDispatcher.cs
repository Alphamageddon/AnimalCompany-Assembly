...
public sealed class EventDispatcher
{
	...
	private sealed class <>c
	{
		...
		internal Queue<EventRecord> <.cctor>b__31_0() { }
	...
	private Stack<DispatchContext> m_DispatchContexts; //Field offset: 0x38
	private bool m_Immediate; //Field offset: 0x40
	[CompilerGenerated]
	[DebuggerBrowsable(DebuggerBrowsableState::Never (0))]
	private bool <processingEvents>k__BackingField; //Field offset: 0x41
