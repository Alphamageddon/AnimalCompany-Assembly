...
public class Clickable : PointerManipulator
{
	...
	private Action<EventBase> clickedWithEventInfo; //Field offset: 0x30
	[CompilerGenerated]
	[DebuggerBrowsable(DebuggerBrowsableState::Never (0))]
	private Action clicked; //Field offset: 0x38
	private readonly long m_Delay; //Field offset: 0x40
	private readonly long m_Interval; //Field offset: 0x48
	[CompilerGenerated]
	[DebuggerBrowsable(DebuggerBrowsableState::Never (0))]
	private bool <active>k__BackingField; //Field offset: 0x50
	[CompilerGenerated]
	[DebuggerBrowsable(DebuggerBrowsableState::Never (0))]
	private Vector2 <lastMousePosition>k__BackingField; //Field offset: 0x54
	private int m_ActivePointerId; //Field offset: 0x5C
	private bool m_AcceptClicksIfDisabled; //Field offset: 0x60
	private IVisualElementScheduledItem m_Repeater; //Field offset: 0x68
