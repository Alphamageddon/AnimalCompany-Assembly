...
internal static class MeshGenerationContextUtils
{
	...
	internal struct RectangleParams
	{
		...
		public BackgroundPosition backgroundPositionX; //Field offset: 0x40
		public BackgroundPosition backgroundPositionY; //Field offset: 0x4C
		public BackgroundRepeat backgroundRepeat; //Field offset: 0x58
		public BackgroundSize backgroundSize; //Field offset: 0x60
		public Texture texture; //Field offset: 0x78
		public Sprite sprite; //Field offset: 0x80
		public VectorImage vectorImage; //Field offset: 0x88
		public Material material; //Field offset: 0x90
		public ScaleMode scaleMode; //Field offset: 0x98
		public Color playmodeTintColor; //Field offset: 0x9C
		public Vector2 topLeftRadius; //Field offset: 0xAC
		public Vector2 topRightRadius; //Field offset: 0xB4
		public Vector2 bottomRightRadius; //Field offset: 0xBC
		public Vector2 bottomLeftRadius; //Field offset: 0xC4
		public Vector2 contentSize; //Field offset: 0xCC
		public Vector2 textureSize; //Field offset: 0xD4
		public int leftSlice; //Field offset: 0xDC
		public int topSlice; //Field offset: 0xE0
		public int rightSlice; //Field offset: 0xE4
		public int bottomSlice; //Field offset: 0xE8
		public float sliceScale; //Field offset: 0xEC
		internal Rect spriteGeomRect; //Field offset: 0xF0
		public Vector4 rectInset; //Field offset: 0x100
		internal ColorPage colorPage; //Field offset: 0x110
		internal MeshFlags meshFlags; //Field offset: 0x118
