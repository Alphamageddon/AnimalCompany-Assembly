...
public class ListView : BaseListView
{
	...
	private Func<VisualElement> m_MakeItem; //Field offset: 0x538
	private Action<VisualElement, Int32> m_BindItem; //Field offset: 0x540
	[CompilerGenerated]
	[DebuggerBrowsable(DebuggerBrowsableState::Never (0))]
	private Action<VisualElement, Int32> <unbindItem>k__BackingField; //Field offset: 0x548
	[CompilerGenerated]
	[DebuggerBrowsable(DebuggerBrowsableState::Never (0))]
	private Action<VisualElement> <destroyItem>k__BackingField; //Field offset: 0x550
