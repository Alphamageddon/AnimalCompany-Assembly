...
public class TreeView : BaseTreeView
{
	...
	private Func<VisualElement> m_MakeItem; //Field offset: 0x4B8
	private Action<VisualElement, Int32> m_BindItem; //Field offset: 0x4C0
	[CompilerGenerated]
	[DebuggerBrowsable(DebuggerBrowsableState::Never (0))]
	private Action<VisualElement, Int32> <unbindItem>k__BackingField; //Field offset: 0x4C8
	[CompilerGenerated]
	[DebuggerBrowsable(DebuggerBrowsableState::Never (0))]
	private Action<VisualElement> <destroyItem>k__BackingField; //Field offset: 0x4D0
