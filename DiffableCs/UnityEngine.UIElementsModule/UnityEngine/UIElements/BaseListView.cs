...
public abstract class BaseListView : BaseVerticalCollectionView
{
	...
	private bool m_ShowBoundCollectionSize; //Field offset: 0x4AC
	private bool m_ShowFoldoutHeader; //Field offset: 0x4AD
	private string m_HeaderTitle; //Field offset: 0x4B0
	[CompilerGenerated]
	[DebuggerBrowsable(DebuggerBrowsableState::Never (0))]
	private Action<IEnumerable`1<Int32>> itemsAdded; //Field offset: 0x4B8
	[CompilerGenerated]
	[DebuggerBrowsable(DebuggerBrowsableState::Never (0))]
	private Action<IEnumerable`1<Int32>> itemsRemoved; //Field offset: 0x4C0
	[CompilerGenerated]
	[DebuggerBrowsable(DebuggerBrowsableState::Never (0))]
	private Action itemsSourceSizeChanged; //Field offset: 0x4C8
	private Label m_ListViewLabel; //Field offset: 0x4D0
	private Foldout m_Foldout; //Field offset: 0x4D8
	private TextField m_ArraySizeField; //Field offset: 0x4E0
	private bool m_IsOverMultiEditLimit; //Field offset: 0x4E8
	private VisualElement m_Footer; //Field offset: 0x4F0
	private Button m_AddButton; //Field offset: 0x4F8
	private Button m_RemoveButton; //Field offset: 0x500
	private Action<IEnumerable`1<Int32>> m_ItemAddedCallback; //Field offset: 0x508
	private Action<IEnumerable`1<Int32>> m_ItemRemovedCallback; //Field offset: 0x510
	private Action m_ItemsSourceSizeChangedCallback; //Field offset: 0x518
	private ListViewReorderMode m_ReorderMode; //Field offset: 0x520
	[CompilerGenerated]
	[DebuggerBrowsable(DebuggerBrowsableState::Never (0))]
	private Action reorderModeChanged; //Field offset: 0x528
	private string m_MaxMultiEditStr; //Field offset: 0x530
	...
	[CompilerGenerated]
	private void <OnAddClicked>b__36_0() { }
